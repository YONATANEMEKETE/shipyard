...
// unknown pagination params are rejected by the object (no second mode).
// Default sort is chronological (startDate asc) — deliberate divergence from
// projects/issues `desc`.
