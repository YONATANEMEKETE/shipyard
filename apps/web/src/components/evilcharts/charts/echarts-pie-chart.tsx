  ...
  return [
    {
      ...
      // `emphasis` is disabled outright when no tooltip is composed: ECharts
      // still paints its default emphasis background over the hovered sector,
      // which on a static gauge (no tooltip to justify it) reads as a glitch.
      emphasis: tooltipSlot.present
        ? { scale: false }
        : { scale: false, disabled: true },
