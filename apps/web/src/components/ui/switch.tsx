      ...
      >
        ...
        <SwitchPrimitive.Root
          ...
          className={cn(
            ...
            'focus-visible:ring-1 focus-visible:ring-[color:var(--ds-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-background',
          )}
          style={{
            width: m.trackWidth,
            ...
            backgroundColor: checked
              ? hovered
                ? 'color-mix(in oklab, var(--foreground), var(--background) 12%)'
                : 'var(--foreground)'
              : hovered
                ? 'color-mix(in oklab, var(--ds-border), var(--foreground) 10%)'
                : 'var(--ds-border)',
          }}
          ...
          <SwitchPrimitive.Thumb
            render={(props) => {
              ...
              return (
                <motion.span
                  {...rest}
                  className="absolute top-0 left-0 block rounded-full bg-[var(--ds-accent)] shadow-sm"
                  initial={false}
                  style={{
